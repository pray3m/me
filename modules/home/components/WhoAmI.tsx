  ...
  return (
    <section className="lg:hidden">
      <div className="flex flex-col gap-6">
        <div
          data-aos="fade-up"
          className="overflow-hidden rounded-3xl border-2 border-foreground/15 bg-muted shadow-[6px_6px_0px_0px_rgba(0,0,0,0.85)] dark:shadow-[6px_6px_0px_0px_rgba(255,255,255,0.12)]"
        >
          <Image
            src="/images/prem.jpg"
            alt="Prem Gautam"
        ...
        <div
          data-aos="fade-up"
          className="group relative overflow-hidden rounded-3xl border-2 border-white/10 bg-[#141414] p-6 shadow-[6px_6px_0px_0px_rgba(99,102,241,0.4)]"
        >
          <BorderBeam />
          ...
          <div data-aos="fade-up" data-aos-delay="500" className="mt-6">
            <Link
              href="/about"
