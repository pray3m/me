...
bun lint:fix      # biome check --write .     (autofix + format)
bun lint:strict   # biome ci .                (CI mode, used in .github/workflows/lint.yml)
bun format        # biome format --write .
bun typecheck     # tsc --noEmit --incremental false
```
